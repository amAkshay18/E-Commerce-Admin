      ...
      content: const SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              '''
Welcome to Admin LeafLoom, your go-to platform for managing and selling plants with ease. 
...
Admin LeafLoom is committed to maintaining the privacy and security of your information. Please refer to our Privacy Policy for more details.

Contact Us:
For any inquiries or assistance, you can mail us at thisisakshayp18@gmail.com.''',
            ),
          ],
        ),
      ),
