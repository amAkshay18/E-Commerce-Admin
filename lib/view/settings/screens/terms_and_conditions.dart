...
3. Plant Information
Admin LeafLoom provides plant information for management purposes. While we strive for accuracy, we do not guarantee the completeness, accuracy, or reliability of plant information displayed in the App.

4. Orders and Earnings
When processing orders and viewing earnings, you agree to provide accurate and truthful information. Admin LeafLoom is not responsible for any discrepancies or errors in orders or earnings that result from inaccurate information.
...
The App and its original content, features, and functionality are owned by Admin LeafLoom and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.

8. Limitation of Liability
In no event shall Admin LeafLoom, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
