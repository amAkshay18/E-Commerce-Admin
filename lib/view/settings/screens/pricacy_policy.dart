      ...
      content: const SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              '''
Privacy Policy for Admin Gardenia

  Last Updated: 25-11-2023

    Admin Gardenia we operates the Admin Gardenia mobile application . This page informs you of our policies regarding the collection, use, and disclosure of Personal Information and data when you use our App.
